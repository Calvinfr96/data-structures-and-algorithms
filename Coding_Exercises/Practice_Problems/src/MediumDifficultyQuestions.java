...
public class MediumDifficultyQuestions {
    ...
    class PhoneNumberMnemonicsProgram {
      private static final Map<Character, String[]> DIGIT_LETTERS = new HashMap<>();
    ...
    class longestPalindromeProgram {
      // Write your code here. Example: "abaxyzzxf"
      //For this algorithm, you need to treat each letter as the center of a palindrome.
      //In the example, you treat "a" as the center and expand to the right and left. Since
      //there are no characters to the left of "a", "a" is the longest palidrome that centers at "a".
      //Next, you check "b". Since the characters to the left and right are equal, "aba" is your
      //new longest palindrome. You can't expand further to the left, so "aba" is the longest
      //palindrome centered at "b".
      //Next, you consider a palindrome centered between "a" and "b" (centered at "ab"). Since
      //You can't expand further to the left, an empty string (the character between "a" and "b")
      //is the longest palindrome centered at "ab". Also, "a" and "b" are not equal, so it couldn't
      //be a palindrome anyways.
      //Next, you check "a" and then "ba" and continue in this fashion to the end of the string.
      public static String longestPalindromicSubstring(String str) {
        int[] currentLongest = new int[] {0, 1};
        for(int i = 1; i < str.length(); i++) {
          //This will span three letters of the string If the letters at the left and right
          //ends are not equal, this will return the array [i, i+1], which corresponds to
          //the center character in the substring represented by the indices.
          int[] odd = getLongestPalindrome(str, i - 1, i + 1);
          //This will span two letters of the string. If the letters at the left and right
          //ends are not equal, this will return the array [i, i], which corresponds to an
          //empty string.
      ...
      public static int[] getLongestPalindrome(String str, int leftIndex, int rightIndex) {
